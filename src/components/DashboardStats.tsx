      ...
      <div className="flex flex-col sm:flex-row items-center gap-8 justify-around">
        ...
        <div className="relative w-40 h-40 flex items-center justify-center">
          ...
          <div className="absolute flex flex-col items-center justify-center text-center">
            ...
            <span className="text-[10px] text-gray-400 dark:text-gray-550 font-bold uppercase tracking-wider mt-1">
              Done Today
            </span>
          </div>
        </div>
        ...
        <div className="space-y-4 w-full sm:w-auto flex-1 max-w-[200px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-gray-400 dark:text-gray-550 uppercase tracking-tight leading-none">Missions Complete</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-gray-400 dark:text-gray-550 uppercase tracking-tight leading-none">Streak Progression</p>
          ...
          <div className="bg-orange-50/50 dark:bg-orange-950/10 p-3 rounded-2xl border border-orange-100/40 dark:border-orange-900/30 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[9px] font-bold text-orange-400 dark:text-orange-555 uppercase tracking-tighter mt-0.5">Active Streak</p>
              </div>
            </div>
