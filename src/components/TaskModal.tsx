            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="text-gray-400 hover:text-red-550 p-1 rounded-lg transition-colors cursor-pointer"
                        >
                          <Trash2 size={16} />
                        </button>
                      </div>
                      ...
                      <div className="flex items-center gap-2 pt-1">
                        ...
                        <select
                          ...
                          className="px-2 py-0.5 text-xs border border-gray-250 dark:border-[#2D2D2D] rounded-lg outline-none text-gray-800 dark:text-gray-250 bg-white dark:bg-[#1E1E1E] focus:border-[#00E5FF] dark:focus:border-[#00E5FF] font-bold"
                        >
              ...
              <div className="pt-2 flex gap-3 sticky bottom-0 bg-white dark:bg-[#1E1E1E] pb-2 mt-auto">
                <button
                  type="button"
                  onClick={onClose}
                  className="flex-1 py-3 px-4 rounded-2xl border border-gray-205 dark:border-[#2D2D2D] font-bold text-gray-550 dark:text-gray-450 hover:bg-gray-50 dark:hover:bg-[#121212] transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
