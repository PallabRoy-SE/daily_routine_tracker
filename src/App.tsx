  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#121212] text-gray-900 dark:text-[#f3f4f6] transition-colors duration-250 pb-24 md:pb-12">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-[#1E1E1E] border-t border-gray-200/50 dark:border-[#2D2D2D]/60 md:hidden flex justify-around items-center py-2.5 px-4 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
        <button
          onClick={() => setActiveView('home')}
          className={`flex flex-col items-center gap-1 py-1 px-3 rounded-xl transition-all ${activeView === 'home' ? 'text-blue-600 dark:text-[#00E5FF]' : 'text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'
            }`}
        >
          <HomeIcon size={20} />
        ...
        <button
          onClick={() => setActiveView('journal')}
          className={`flex flex-col items-center gap-1 py-1 px-3 rounded-xl transition-all ${activeView === 'journal' ? 'text-blue-600 dark:text-[#00E5FF]' : 'text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'
            }`}
        >
          <BookOpen size={20} />
        ...
        <button
          onClick={() => setActiveView('profile')}
          className={`flex flex-col items-center gap-1 py-1 px-3 rounded-xl transition-all ${activeView === 'profile' ? 'text-blue-600 dark:text-[#00E5FF]' : 'text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'
            }`}
        >
          <User size={20} />
