  ...
  return (
    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm transition-all hover:shadow-md">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-800 tracking-tight">Mission XP Progression</h2>
          <p className="text-sm text-gray-500 font-medium tracking-tight">Your daily XP gains over the last 30 days</p>
        </div>
      </div>
      ...
      <div className="mt-4 flex items-center justify-center gap-6">
         <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Daily Gain</span>
         </div>
      </div>
    </div>
  );
